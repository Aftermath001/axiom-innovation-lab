        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-[1fr_1.1fr]">
          <div className="space-y-6">
            <p className="max-w-md text-muted-foreground">
              Tell us about your ambition. We'll respond within one business
              day with next steps or scheduling for a consultation.
            </p>
            ...
            <ul className="space-y-4 text-sm">
              <ContactRow
                ...
                label="Email"
                value="metamindlimited@gmail.com"
              />

              <ContactRow
                icon={<Phone className="h-4 w-4" />}
                label="Phone"
                value="+254 798 611 952"
              />
