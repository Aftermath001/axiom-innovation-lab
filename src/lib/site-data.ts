...
export const industries = [
  {
    ...
    icon: Building2,
    desc: "Core banking, payments, risk & compliance modernization.",
  },
  {
    title: "Healthcare",
    icon: HeartPulse,
    desc: "Digital health platforms, EMR, telemedicine and analytics.",
  },
  {
    title: "Education",
    icon: GraduationCap,
    desc: "Learning platforms, student systems, EdTech innovation.",
  },
  {
    title: "Logistics",
    icon: Truck,
    desc: "Fleet, warehousing, last-mile and supply-chain visibility.",
  },
  {
    title: "Government",
    icon: Landmark,
    desc: "Citizen services, e-Government and secure digital public infrastructure.",
  },
  {
    title: "Retail",
    icon: ShoppingBag,
    desc: "Omnichannel commerce, loyalty and AI-driven personalization.",
  },
  {
    title: "Manufacturing",
    icon: Factory,
    desc: "Industry 4.0, IIoT, predictive maintenance and OT/IT convergence.",
  },
] as const;
...
export const caseStudies = [
  {
    ...
    results: [
      "7× faster product releases",
      "$2.4M annual infrastructure savings",
      "PCI-DSS re-certified",
    ],
  ...
  },
  {
    ...
    results: [
      "38% shorter waiting times",
      "22% fewer misclassifications",
  ...
  },
  {
    ...
    results: [
      ...
      "60% reduction in service wait time",
...
export const blogPosts = [
  {
    slug: "ai-automation-kenyan-businesses",
    title: "How AI Automation Is Helping Kenyan Businesses Save Time, Reduce Costs and Grow Faster",
    excerpt:
