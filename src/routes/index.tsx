...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      {
        title: "AI, Software & IT Services in Kenya | MetaMind",
      },
      {
        name: "description",
        content:
          "MetaMind provides AI automation, software development, IT consulting, cybersecurity, cloud and digital transformation services for businesses in Kenya and beyond.",
      },
      {
        property: "og:title",
        content: "AI, Software & IT Services in Kenya | MetaMind",
      },
      {
        property: "og:description",
        content:
          "AI automation, software development and practical technology solutions for businesses in Kenya and beyond.",
      },
      {
        property: "og:url",
        content: "https://metamindlimited.co.ke/services",
      },
    ],
    links: [
      {
        rel: "canonical",
        href: "https://metamindlimited.co.ke/services",
      },
    ],
  }),
  component: Services,
